...
export const AVATARS = [
  ...
  "https://api.dicebear.com/9.x/micah/svg?seed=Tech",
  "https://api.dicebear.com/9.x/micah/svg?seed=Sasha",
  "https://api.dicebear.com/9.x/micah/svg?seed=Alex",
  "https://api.dicebear.com/9.x/micah/svg?seed=Jace",
  ...
  "https://api.dicebear.com/9.x/micah/svg?seed=Sam",
  "https://api.dicebear.com/9.x/micah/svg?seed=Robot01",
  "https://api.dicebear.com/9.x/micah/svg?seed=Happy",
  "https://api.dicebear.com/9.x/micah/svg?seed=Buddy",
  "https://api.dicebear.com/9.x/micah/svg?seed=Maria",
  "https://api.dicebear.com/9.x/micah/svg?seed=Jack",
  "https://api.dicebear.com/9.x/micah/svg?seed=Sarah",
  "https://api.dicebear.com/9.x/micah/svg?seed=David",
  "https://api.dicebear.com/9.x/micah/svg?seed=Emma",
  "https://api.dicebear.com/9.x/micah/svg?seed=Bot2",
  "https://api.dicebear.com/9.x/micah/svg?seed=Lily",
  "https://api.dicebear.com/9.x/micah/svg?seed=Tom",
  "https://api.dicebear.com/9.x/micah/svg?seed=Mia",
  "https://api.dicebear.com/9.x/micah/svg?seed=Noah",
  "https://api.dicebear.com/9.x/micah/svg?seed=Olivia"
];
